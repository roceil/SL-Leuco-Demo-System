...
import { UserIcon, LockClosedIcon, ArrowRightOnRectangleIcon, SunIcon, MoonIcon } from '@heroicons/vue/24/outline'
    ...
    >
      ...
      <form @submit.prevent="handleSubmit" class="space-y-5">
        ...
        <div>
          ...
          <p v-if="usernameError" class="text-red-500 text-sm mt-1.5 flex items-center gap-1">
        ...
        <div>
          ...
          <p v-if="passwordError" class="text-red-500 text-sm mt-1.5 flex items-center gap-1">
            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
            </svg>
            請輸入密碼
        ...
        <button
          type="submit"
          class="w-full py-3.5 px-6 rounded-lg text-base font-semibold cursor-pointer transition-all focus:outline-none focus:ring-4 flex items-center justify-center gap-2 mt-6"
          :class="[
            theme === 'dark'
              ? 'bg-primary-600 hover:bg-primary-700 text-white focus:ring-primary-900'
              : 'bg-primary-500 hover:bg-primary-600 text-white focus:ring-primary-200 shadow-lg hover:shadow-xl'
          ]"
        >
          <span>登入</span>
      ...
      <div class="mt-6 text-center">
        ...
        >
          © 2024 藍白航運訂票系統. All rights reserved.
        </p>
      </div>
    </div>
  </div>
